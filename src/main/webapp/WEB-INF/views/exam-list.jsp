...
<jsp:include page="/WEB-INF/views/header.jsp">
	<jsp:param value="Exams" name="title"/>
</jsp:include>
<!-- Include Sidebar -->
                ...
                <table class="table datanew">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><% for (ClassX classX : classList) {
                        if (classX.getClassId() == exam.getClassId()) {
                            out.print(classX.getClassName());
                        }
                      } %></td>
                      <td><% for (AcademicStaff academicStaff : academicStaffs) { 
                        if(academicStaff.getStaffId() == exam.getAcademicStaffId()) {
                            out.print(academicStaff.getFirstName() + " " + academicStaff.getLastName());
                        }
                        } %></td>
                      <td><%=exam.getCreatedAt()%></td>
                      <td><%=exam.getUpdatedAt()%></td>
                      <td>
                        <a class="me-3" href="modify-exam?id=<%=exam.getExamId()%>">
                          <img src="assets/img/icons/edit.svg" alt="img" />
                        </a>
                        <a class="me-3" href="delete-exam?id=<%=exam.getExamId()%>" onclick="return confirm('Are you sure you want to delete this item?');">
