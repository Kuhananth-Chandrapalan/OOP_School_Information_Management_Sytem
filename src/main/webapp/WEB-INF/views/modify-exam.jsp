...
<jsp:include page="/WEB-INF/views/header.jsp">
	<jsp:param value="Add Exam" name="title"/>
</jsp:include>
<!-- Include Sidebar -->
<jsp:include page="/WEB-INF/views/academic-staff-sidebar.jsp"></jsp:include>
	...
	<div class="page-wrapper">
        <div class="content">
          ...
          <div class="card">
            <div class="card-body">
              <form action="modify-exam" method="post" class="was-validated">
                <div class="row">
                  <div class="col-lg-3 col-sm-6 col-12">
                    <div class="form-group">
                      <label>Exam Id</label>
                      <input type="text" placeholder="Enter Exam Id" name="id" value="<%=exam.getExamId()%>" readonly/>
                  	</div>
                  </div>
                  <div class="col-lg-3 col-sm-6 col-12">
                    <div class="form-group">
                      <label>Exam Name</label>
                      <input class="form-control is-invalid" type="text" placeholder="Enter Exam Name" name="name" required value="<%=exam.getExamName()%>"/>
                    </div>
                  </div>
                  <div class="col-lg-3 col-sm-6 col-12">
	                  <div class="form-group">
